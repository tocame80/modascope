...
const content = {
  en: {
    ...
    digestPreview: "Daily Digest Preview",
    sourcesTitle: "Data Sources",
    personaliztionTitle: "Personalization",
  ...
  ru: {
    ...
    digestPreview: "Пример ежедневного дайджеста",
    sourcesTitle: "Источники данных",
    personaliztionTitle: "Персонализация",
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0A0A0A]/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm text-[#F5F0E8]/70">
            ...
            <a href="#preview" className="hover:text-[#C9A962] transition-colors">{t.digestPreview}</a>
